...
require_once "global.php";
  ...
  $especialidade2 = new Especialidade("Ortodontia", [
      $procedimento8, $procedimento9
  ]);
  $especialidade3 = new Especialidade("Periodontia", [
      $procedimento9
  ]);
  $especialidade4 = new Especialidade("Cirurgia Oral", [
      $procedimento3, $procedimento12
  ]);
  $especialidade5 = new Especialidade("Implantodontia", [
      $procedimento7
  ]);
  $especialidade6 = new Especialidade("Odontopediatria", [
      $procedimento11
  ]);
  $especialidade7 = new Especialidade("Endodontia", [
      $procedimento5, $procedimento5, $procedimento5
  ]);
  $especialidade8 = new Especialidade("Dentística Restauradora", [
      $procedimento4, $procedimento4, $procedimento6, $procedimento6, $procedimento6
  ]);

  $especialidade9 = new Especialidade("Prótese Dentária", [
      $procedimento6, $procedimento6, $procedimento13
  ]);
  $especialidade10 = new Especialidade("Odontologia Estética", [
      $procedimento10, $procedimento6, $procedimento6, $procedimento6
  ]);
  $especialidade11 = new Especialidade("Odontologia do Sono", [
      $procedimento14, $procedimento12
  ]);
  $especialidade12 = new Especialidade("Odontologia Preventiva", [
      $procedimento15, $procedimento10, $procedimento2
  ]);
