...
$anderson->criarPaciente ("leonardo de sa", "leonardo@gmail", 982118390, "213", "18/09");
$anderson->criarPaciente ("daniel de sa", "daniel@gmail", 978516514, "sda", "10/09");

echo $anderson->getPaciente(0)->getNome();
