...
class DentistaParceiro extends Dentista
{
	...
	public function __construct(string $nome, string $email, int $telefone, string $cpf, Endereco $endereco, string $cro, array $especialidades)
	{
		parent::__construct($nome, $email, $telefone, $cpf, $endereco, $cro, $especialidades);
	}
